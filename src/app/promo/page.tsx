...
export default function PromoPage() {
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col">
      <header className="flex-none border-b border-neutral-800 px-4 py-4 desktop-layout:px-8">
      ...
      <main className="flex-1 px-4 py-8 desktop-layout:px-8 desktop-layout:py-12 max-w-2xl mx-auto w-full">
        <h1 className="text-2xl desktop-layout:text-3xl font-bold text-white mb-6">About Project</h1>
        <div className="space-y-6 text-neutral-300 text-sm desktop-layout:text-base leading-relaxed">
          <p>
